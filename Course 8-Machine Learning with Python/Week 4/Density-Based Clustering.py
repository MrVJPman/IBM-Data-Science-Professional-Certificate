...
minimumSamples = 7 #minimumSamples determine the minimum number of data points we want in a neighborhood to define a cluster. 
db = DBSCAN(eps=epsilon, min_samples=minimumSamples).fit(X)
labels = db.labels_


#===Outliers : Lets Replace all elements with 'True' in core_samples_mask that are in the cluster, 'False' if the points are outliers.
...
#Practice : To better underestand differences between partitional and density-based clusteitng, 
...
pdf = pd.read_csv(filename='weather-stations20140101-20141231.csv')
